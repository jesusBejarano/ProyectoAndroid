...
public class HttpClientUtil {
    ...
    public static String POST(String urlRest, String param) throws Exception {
        ...
        try {
            URL url = new URL(String.format("http://%s/LicoreriaRest/%s", "192.168.5.81", urlRest));
...
//            String result = json.getString("result");
    ...
    public static String GET(String urlRest, JSONObject param) throws Exception {
        HttpURLConnection conn = null;
        OutputStream os = null;
        BufferedReader reader = null;

        try {
            URL url = new URL(String.format("http://%s/LicoreriaRest/%s", "10.0.2.2", urlRest));
            conn = (HttpURLConnection) url.openConnection();
